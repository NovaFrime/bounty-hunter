...
//     let results = [];
//     document.querySelectorAll("#__next > div.hot-deal-page > main > div > div > div:nth-child(7) > div").forEach(element => {
//       let text = element.querySelector('div.title').textContent;
//       results.push(text);
//     });
//     return results;
//   });
